...
from flask_login import UserMixin, AnonymousUserMixin  # remember the status of user login in info
...
class Role(db.Model):
    ...
    default = db.Column(db.Boolean, default=False, index=True)  # if only one character,default will set to true
...
class User(UserMixin, db.Model):
    ...
    def __init__(self, **kwargs):  # the admin role will get full right while it regs
...
class Post(db.Model):
    ...
    @staticmethod
    def generate_fake(count=100):   # use forgerypy generate fake post
